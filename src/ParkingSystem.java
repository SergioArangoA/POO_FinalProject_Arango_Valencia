        ...
        try {
            ...
            while(true) {
                try {
                  ...
                  io.writeLine("Error crítico: No se pudo crear el archivo de guardado automáticamente.");
                  io.writeLine("Por favor verifique que tenga permisos de escritura en esta carpeta.");
                  break; 
}
            }
        }
